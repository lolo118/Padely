    ...
    <div>
      ...
      {mostrarConfig && (
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 mb-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div>
              <label className={labelClass}>Días de anticipación máxima</label>
              <input
                type="number"
                min="1"
                max="60"
      ...
      {mostrarForm && (
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-green-200 mb-4">
          <h2 className="font-semibold text-green-700 mb-3">Nueva cancha</h2>
          <form onSubmit={handleCrearCancha} className="flex flex-col gap-3">
            <div>
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormCancha({ ...formCancha, superficie: e.target.value })
                  }
              ...
              <div className="flex-1">
                <label className={labelClass}>Precio base por turno ($)</label>
                <input
                  type="number"
                  min="0"
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">
                {Object.keys(formCancha.horarios).length} horarios seleccionados
              </p>
            </div>
            <button
              type="submit"
      ...
      {canchas.length === 0 && !mostrarForm && (
        <div className="text-center py-16 bg-white rounded-2xl border border-gray-100 shadow-sm mb-4">
          ...
          <p className="text-gray-500 font-medium">No tenés canchas creadas</p>
          <p className="text-gray-400 text-sm mt-1">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        setEditForm({ ...editForm, techada: e.target.checked })
                      }
                      className="w-4 h-4 accent-green-600"
                    />
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 mt-1 flex-wrap">
                        ...
                        <span className="text-xs bg-blue-100 text-blue-600 px-2 py-0.5 rounded-full">
                          {(cancha.horariosDisponibles || []).length} horarios
                        </span>
                      </div>
                    </div>
                    <div className="flex gap-2">
